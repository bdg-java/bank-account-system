...
import com.bdg.service.account.creditcard.CreditCardCrudService;
import com.bdg.service.account.creditcard.CreditCardNumberGenerator;
import com.bdg.service.account.creditcard.CreditCardService;
...
public class BankAccountSystem {
    ...
    public static void main(String[] args) {
        ...
        service.create(generator.generate(), 32, "10-10-2020", "VISA");
        service.remove(1);
